...
const Minus = (props: any) => (
  <svg {...props} data-testid='mimus-icon' viewBox='64 -65 897 897'>
    <g>
      <path
...
const Plus = (props: any) => (
  <svg {...props} data-testid='plus-icon' viewBox='64 -65 897 897'>
    <g>
      <path
...
const Close = (props: any) => (
  <svg {...props} data-testid='close-icon' viewBox='64 -65 897 897'>
    <g>
      <path
